...
"""
    所谓"反射"，指的是以字符串的形式来操作（包括增删改查）对象的属性和方法。
...
4. delattr(object, name)
    ...
    注意: 只有在不知道对象信息的情况下，才会获取对象的信息。因此，如果可以直接写: object.name,
...
# <bound method MyClass.do_sth of <__main__.MyClass object at 0x10e98c670>>
